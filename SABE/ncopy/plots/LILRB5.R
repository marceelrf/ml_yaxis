	...
	db <- read.table('LILRB5_plot_db.txt',h=T,sep='\t')
	...
	p <- ggplot(data=db) + 
		...
		labs(title='LILRB5', caption = 'Calculated using the wgs mode')
	
	ggsave("/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//LILRB5.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, '/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//LILRB5.html', selfcontained = F, libdir = '/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//LILRB5')