	...
	ggsave("/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//KIR3DL1.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, '/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//KIR3DL1.html', selfcontained = F, libdir = '/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//KIR3DL1')