	...
	ggsave("/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//KIR2DS3.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, '/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//KIR2DS3.html', selfcontained = F, libdir = '/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//KIR2DS3')