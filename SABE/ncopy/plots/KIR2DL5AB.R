	...
	db <- read.table('KIR2DL5AB_plot_db.txt',h=T,sep='\t')
	...
	p <- ggplot(data=db) + 
		...
		labs(title='KIR2DL5AB', caption = 'Calculated using the wgs mode')
	
	ggsave("/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//KIR2DL5AB.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, '/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//KIR2DL5AB.html', selfcontained = F, libdir = '/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//KIR2DL5AB')