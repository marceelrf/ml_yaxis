	...
	db <- read.table('HLA-G_plot_db.txt',h=T,sep='\t')
	...
	p <- ggplot(data=db) + 
		...
		labs(title='HLA-G', caption = 'Calculated using the wgs mode')
	
	ggsave("/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//HLA-G.png", width=8, height=6,bg = "white")
	...
	saveWidget(myplot, '/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//HLA-G.html', selfcontained = F, libdir = '/media/lab/Data/kir-mapper_SABE/output//ncopy//plots//HLA-G')